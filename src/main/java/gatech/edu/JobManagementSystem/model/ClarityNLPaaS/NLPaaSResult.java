...
public class NLPaaSResult {
	...
	public String toString() {
		return "NLPaaSResult [_id=" + _id + ", batch=" + batch + ", concept_code=" + concept_code
				...
				+ display_name + ", inserted_date=" + inserted_date + ", job_id=" + job_id + ", location=" + location
				+ ", name=" + name + ", nlpql_feature=" + nlpql_feature + ", owner=" + owner + ", phenotype_final="
				+ phenotype_final + ", pipeline_id=" + pipeline_id + ", pipeline_type=" + pipeline_type
				+ ", report_date=" + report_date + ", report_id=" + report_id + ", report_text=" + report_text
				+ ", report_type=" + report_type + ", result=" + result + ", resultType=" + resultType
				+ ", result_display=" + result_display + ", solr_id=" + solr_id + ", source=" + source + ", subject="
				+ subject + ", tuples=" + tuples + "]";
	}
