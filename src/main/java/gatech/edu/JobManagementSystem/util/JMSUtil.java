...
public class JMSUtil {
	...
	public static PersonList perparePersonListForPersistence(PersonList personList) {
		...
		if(action == null) {
			...
			action.addParam("endpoint","http://resultsmanager:8080/ResultsManager/case?patientId=${person.id}&firstName=${person.firstName}&lastName=${person.lastName}&cqlType=myCQL");
